import {
  ...
  Config as H_Config,
  Result as H_Result,
  DrawOptions as H_DrawOptions,
  // Config
  FilterConfig as H_FilterConfig,
  GestureConfig as H_GestureConfig,
  FaceConfig as H_FaceConfig,
  BodyConfig as H_BodyConfig,
  HandConfig as H_HandConfig,
  ObjectConfig as H_ObjectConfig,
  SegmentationConfig as H_SegmentationConfig,
  // Result
  FaceResult as H_FaceResult,
  BodyResult as H_BodyResult,
  HandResult as H_HandResult,
  GestureResult as H_GestureResult,
  ObjectResult as H_ObjectResult,
  PersonResult as H_PersonResult,
  // FaceConfig
  FaceDetectorConfig as H_FaceDetectorConfig,
  FaceMeshConfig as H_FaceMeshConfig,
  FaceDescriptionConfig as H_FaceDescriptionConfig,
  FaceEmotionConfig as H_FaceEmotionConfig,
  FaceGearConfig as H_FaceGearConfig,
} from 'ngx-scanner-face-human';

// Models
export class Env extends H_Env {}

export class Human extends H_Human {}
...
export type GestureResult = H_GestureResult;
